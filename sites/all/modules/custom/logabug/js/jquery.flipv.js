...
$.fn.flipv = function(options) {
	...
	this.each(function(){ 	
		...
		var widthsav = textsav.length*fontsizesav*.65;
		...
		if ($.browser.msie) {
			$(this).css('font-size', fontsizesav).css('width', heightsav+'px').css('height', widthsav-2+'px').css('font-family', 'Verdana').css('writing-mode', 'tb-rl').css('font-weight', 'bold');
		} else {
