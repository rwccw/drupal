...
// Rebuild registery every page load. Comment this out when your done!!!
...
if ((arg(0) == 'node') && (arg(1) == 'add') && (arg(2) == 'content_cal_event')){
  function phptemplate_node_form($form) {
    return _phptemplate_callback('cal_event_edit', array('user' => $user, 'form' => $form));
  }
}
// Add Form End
